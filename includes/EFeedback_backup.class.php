...
//   params: <none>
{
	...
	//function EFeedback($global_params, $params, $module_id, $node_id = NULL, $module_uri = NULL)
	function EFeedback($params, $global_params, $module_id, $node_id = NULL, $module_uri = NULL)
	{
		global $Engine;
		...
		$config_file = $global_params;

		// Обработка параметров
		$parts = explode(";", $params);
		$this->mode = $parts[0];
		
		//$this->output["mode"] = "olymp";
