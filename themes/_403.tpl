...
<!--[if lte IE 7]><div id="no-ie6">
    ...
    <div id="nofooter">
		<div class="wrapper">
		    ...
		    <div id="content">
				<h1>Ошибка HTTP 403</h1>
				<p>Вы не имеете доступа к данной странице сайта</p>
				<p>Возможно, Вы не представились системе, чтобы представиться <a href="/office/">введите свои логин и пароль</a>.</p>
				<p>Также возможно, что время вашей сессии истекло.</p>
				<p><a href="/support/registration/">Если вы не зарегистрированы в системе</a>.</p>
		    </div><!--content-->
		</div>
